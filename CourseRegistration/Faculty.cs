...
namespace CourseRegistration
{
    public class Faculty
    {
        ...
        /// <summary>
        /// Create a Faculty object from a string record in the CSV file
        /// </summary>
        /// <param name="StudentLine">A comman delimited string representing each attribute in a Faculty object</param>
        public Faculty(String FacultyLine)
        {
            ...
            {
                throw new Exception("ERROR: Faculty cannot be instantiated due to incorrect number of data elements. Expecting 11, found " + szColumn.Length.ToString());
            }
        }
        ...
        /// <summary>
        /// Convert a Faculty to a string record for the CSV file
        /// </summary>
